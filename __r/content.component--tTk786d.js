...
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/components/content/content.component.ts
var _c0 = ["*"];
...
(() => {
	(typeof wx.__global.ngDevMode === "undefined" || wx.__global.ngDevMode) && require_angular_miniprogram.ɵsetClassDebugInfo(ContentComponent, {
		...
		filePath: "test/test-project-host-hello-world-app-n66njpxabtr/src/components/content/content.component.ts",
		lineNumber: 9
	});
})();
//#endregion
