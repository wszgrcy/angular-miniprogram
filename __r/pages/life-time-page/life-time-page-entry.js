...
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/pages/life-time-page/life-time.component.ts
...
(() => {
	(typeof wx.__global.ngDevMode === "undefined" || wx.__global.ngDevMode) && require_angular_miniprogram.ɵsetClassDebugInfo(LifeTimePage, {
		...
		filePath: "test/test-project-host-hello-world-app-n66njpxabtr/src/pages/life-time-page/life-time.component.ts",
		lineNumber: 12
	});
})();
//#endregion
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/pages/life-time-page/life-time-page.entry.ts
