...
const require_content_component = require("../../content.component--tTk786d.js");
const require_content_module = require("../../content.module-C-IY02un.js");
const require_content_multi_component = require("../../content-multi.component-D-ZIEZ4Y.js");
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/components/content-multi/content-multi.module.ts
...
//#endregion
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/pages/ng-content/ng-content.component.ts
...
(() => {
	(typeof wx.__global.ngDevMode === "undefined" || wx.__global.ngDevMode) && require_angular_miniprogram.ɵsetClassDebugInfo(NgContentComponent, {
		...
		filePath: "test/test-project-host-hello-world-app-n66njpxabtr/src/pages/ng-content/ng-content.component.ts",
		lineNumber: 13
	});
})();
//#endregion
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/pages/ng-content/ng-content.entry.ts
