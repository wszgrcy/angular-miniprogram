...
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/pages/complex-structure/complex-structure.component.ts
...
(() => {
	(typeof wx.__global.ngDevMode === "undefined" || wx.__global.ngDevMode) && require_angular_miniprogram.ɵsetClassDebugInfo(ComplexStructureComponent, {
		...
		filePath: "test/test-project-host-hello-world-app-n66njpxabtr/src/pages/complex-structure/complex-structure.component.ts",
		lineNumber: 12
	});
})();
//#endregion
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/pages/complex-structure/complex-structure.entry.ts
