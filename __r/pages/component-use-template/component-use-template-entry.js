...
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/pages/component-use-template/component-use-template.component.ts
...
(() => {
	(typeof wx.__global.ngDevMode === "undefined" || wx.__global.ngDevMode) && require_angular_miniprogram.ɵsetClassDebugInfo(ComponentUseTemplateComponent, {
		...
		filePath: "test/test-project-host-hello-world-app-n66njpxabtr/src/pages/component-use-template/component-use-template.component.ts",
		lineNumber: 12
	});
})();
//#endregion
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/pages/component-use-template/component-use-template.entry.ts
