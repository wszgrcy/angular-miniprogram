...
const require_component_need_template_component = require("../../component-need-template.component-DGlXEBCj.js");
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/components/component-need-template/component-need-template.module.ts
...
//#endregion
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/pages/self-component/self-component.component.ts
...
(() => {
	(typeof wx.__global.ngDevMode === "undefined" || wx.__global.ngDevMode) && require_angular_miniprogram.ɵsetClassDebugInfo(SelfComponentComponent, {
		...
		filePath: "test/test-project-host-hello-world-app-n66njpxabtr/src/pages/self-component/self-component.component.ts",
		lineNumber: 12
	});
})();
//#endregion
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/pages/self-component/self-component.entry.ts
