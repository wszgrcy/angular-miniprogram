...
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/pages/base-tap/base-tap.component.ts
...
(() => {
	(typeof wx.__global.ngDevMode === "undefined" || wx.__global.ngDevMode) && require_angular_miniprogram.ɵsetClassDebugInfo(BaseTagComponent, {
		...
		filePath: "test/test-project-host-hello-world-app-n66njpxabtr/src/pages/base-tap/base-tap.component.ts",
		lineNumber: 13
	});
})();
//#endregion
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/pages/base-tap/base-tap.entry.ts
