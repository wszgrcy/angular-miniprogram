...
const require_component1_component = require("../../component1.component-C27ZQKeZ.js");
const require_component1_module = require("../../component1.module-BCj8VsOr.js");
const require_component2_component = require("../../component2.component-CfD_lpWG.js");
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/components/component2/component2.module.ts
...
//#endregion
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/pages/base-component/base-component.component.ts
...
(() => {
	(typeof wx.__global.ngDevMode === "undefined" || wx.__global.ngDevMode) && require_angular_miniprogram.ɵsetClassDebugInfo(BaseComponentComponent, {
		...
		filePath: "test/test-project-host-hello-world-app-n66njpxabtr/src/pages/base-component/base-component.component.ts",
		lineNumber: 13
	});
})();
//#endregion
//#region test/test-project-host-hello-world-app-n66njpxabtr/src/pages/base-component/base-component.entry.ts
