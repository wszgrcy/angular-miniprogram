...
//#region test/test-project-host-hello-world-app-nc9qibuwjfh/src/pages/base-directive/directive1.directive.ts
...
//#endregion
//#region test/test-project-host-hello-world-app-nc9qibuwjfh/src/pages/base-directive/base-directive.component.ts
...
(() => {
	(typeof wx.__global.ngDevMode === "undefined" || wx.__global.ngDevMode) && require_angular_miniprogram.ɵsetClassDebugInfo(BaseDirectiveComponent, {
		...
		filePath: "test/test-project-host-hello-world-app-nc9qibuwjfh/src/pages/base-directive/base-directive.component.ts",
		lineNumber: 13
	});
})();
//#endregion
//#region test/test-project-host-hello-world-app-nc9qibuwjfh/src/pages/base-directive/base-directive.entry.ts
