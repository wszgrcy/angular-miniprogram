...
const require_component3_component = require("../../component3.component-DJ-Lz4U5.js");
//#region test/test-project-host-hello-world-app-nc9qibuwjfh/src/pages/complex-property-event/app-dir1.directive.ts
...
//#endregion
//#region test/test-project-host-hello-world-app-nc9qibuwjfh/src/pages/complex-property-event/complex-property-event.component.ts
...
(() => {
	(typeof wx.__global.ngDevMode === "undefined" || wx.__global.ngDevMode) && require_angular_miniprogram.ɵsetClassDebugInfo(ComplexPropertyEventComponent, {
		...
		filePath: "test/test-project-host-hello-world-app-nc9qibuwjfh/src/pages/complex-property-event/complex-property-event.component.ts",
		lineNumber: 19
	});
})();
//#endregion
//#region test/test-project-host-hello-world-app-nc9qibuwjfh/src/pages/complex-property-event/complex-property-event.entry.ts
