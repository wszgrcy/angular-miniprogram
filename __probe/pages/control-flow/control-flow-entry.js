...
//#region test/test-project-host-hello-world-app-nc9qibuwjfh/src/pages/control-flow/control-flow.component.ts
...
(() => {
	(typeof wx.__global.ngDevMode === "undefined" || wx.__global.ngDevMode) && require_angular_miniprogram.ɵsetClassDebugInfo(ControlFlowComponent, {
		...
		filePath: "test/test-project-host-hello-world-app-nc9qibuwjfh/src/pages/control-flow/control-flow.component.ts",
		lineNumber: 21
	});
})();
//#endregion
//#region test/test-project-host-hello-world-app-nc9qibuwjfh/src/pages/control-flow/control-flow.entry.ts
