...
//#region test/test-project-host-hello-world-app-nc9qibuwjfh/src/pages/base-http/base-http.component.ts
...
(() => {
	(typeof wx.__global.ngDevMode === "undefined" || wx.__global.ngDevMode) && require_angular_miniprogram.ɵsetClassDebugInfo(BaseHttpComponent, {
		...
		filePath: "test/test-project-host-hello-world-app-nc9qibuwjfh/src/pages/base-http/base-http.component.ts",
		lineNumber: 13
	});
})();
//#endregion
//#region test/test-project-host-hello-world-app-nc9qibuwjfh/src/pages/base-http/base-http.entry.ts
