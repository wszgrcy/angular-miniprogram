...
const require_component1_component = require("./component1.component-CKS4eLIK.js");
//#region test/test-project-host-hello-world-app-y1jg3w78zjg/src/components/component2/component2.component.ts
...
(() => {
	(typeof wx.__global.ngDevMode === "undefined" || wx.__global.ngDevMode) && require_angular_miniprogram.ɵsetClassDebugInfo(Component2Component, {
		...
		filePath: "test/test-project-host-hello-world-app-y1jg3w78zjg/src/components/component2/component2.component.ts",
		lineNumber: 9
	});
})();
//#endregion
