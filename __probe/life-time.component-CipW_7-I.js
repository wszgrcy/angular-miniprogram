...
//#region test/test-project-host-hello-world-app-y1jg3w78zjg/src/components/life-time/life-time.component.ts
...
(() => {
	(typeof wx.__global.ngDevMode === "undefined" || wx.__global.ngDevMode) && require_angular_miniprogram.ɵsetClassDebugInfo(LifeTimeComponent, {
		...
		filePath: "test/test-project-host-hello-world-app-y1jg3w78zjg/src/components/life-time/life-time.component.ts",
		lineNumber: 9
	});
})();
//#endregion
