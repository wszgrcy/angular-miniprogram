...
//#region test/test-project-host-hello-world-app-elc7t9gekx/src/components/content-multi/content-multi.component.ts
var _c0 = [[[
	"",
	"slot",
	"slot1"
...
(() => {
	(typeof wx.__global.ngDevMode === "undefined" || wx.__global.ngDevMode) && require_angular_miniprogram.ɵsetClassDebugInfo(ContentMultiComponent, {
		...
		filePath: "test/test-project-host-hello-world-app-elc7t9gekx/src/components/content-multi/content-multi.component.ts",
		lineNumber: 9
	});
})();
//#endregion
